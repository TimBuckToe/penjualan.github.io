...
<form class="justify-content-center align-items-center" action="<?= $base_url ?>customer/save" method="post">
    <div>
        ...
        <input class="metro-input mb-3" type="text" name="nmcust" id="" placeholder="Nama customer" required>
    </div>

    <div>
        <label for="" class="form-label">jenis Kelamin</label>
        <select name="jenkel" id="" class="metro-input mb-3" required>
            <option>Pilih</option>
    ...
    <div>
        ...
        <input class="metro-input mb-3" type="date" name="tgllahir" id="" required>
    </div>

    <div class="form-floating">
        <textarea class="metro-input mb-3" placeholder="Alamat customer" id="floatingTextarea" name="alamat"></textarea>
    ...
    <div>
        <button type="submit" class="button success rounded-pill  mb-1">Simpan</button>
